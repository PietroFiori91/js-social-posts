...
for (let i = 0; i < posts.length; i++) {
  ...
  //DIV CREATI
  const postMyContainer = document.createElement("div");
  postMyContainer.classList.add("post");
  postContainer.append(postMyContainer);

  postMyContainer.innerHTML = `<div class="post__header">
        <div class="post-meta">                    
